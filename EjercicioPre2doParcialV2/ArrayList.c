...
int al_add(ArrayList* this, void* pElement)
{
    ...
    {
        size = al_len(this);
        reservedSize = al_lenReservedSize(this);
        if((size < reservedSize) || !resizeUp(this))
        {
...
{
    void* returnAux = NULL;
    if(this != NULL && index >= 0 && al_len(this) > index)
    {
...
ArrayList* al_clone(ArrayList* this)
{
    ...
    if(this != NULL)
    {
        ...
        returnAux->reservedSize = al_lenReservedSize(this);
    }
    return returnAux;
}
...
ArrayList* al_subList(ArrayList* this,int from,int to)
{
    void* returnAux = NULL;
    int i;
    if(this != NULL && from >= 0 && to >= from && to <= al_len(this))
    {
        returnAux = al_newArrayList();
        for(i = from; i <= to; i++)
        {
...
{
    int returnAux = -1;
    if(this!=NULL && pFunc!=NULL && (order==1 || !order) && al_len(this) > 1)
    {
        returnAux = 0;
        int i;
        int flagSwap;
...
int resizeUp(ArrayList* this)
{
    ...
    if(this != NULL)
    {
        auxiliar = (ArrayList*) realloc(this->pElements, sizeof(void*)*(this->reservedSize + AL_INCREMENT));
        if(auxiliar != NULL)
        {
...
int expand(ArrayList* this,int index)
{
    ...
    {
        if((al_len(this) < al_lenReservedSize(this)) || (!resizeUp(this)))
        {
            this->size = this->size + 1;
...
int al_lenReservedSize(ArrayList* this)
{
    int returnAux = -1;
    if(this != NULL)
    {
        returnAux = this->reservedSize;
    }
    return returnAux;
}


int al_map(ArrayList* this,void(*punteroAfuncion)(void* ,void* ))
{
    int retorno=-1;
    Empleado* auxiliar;
    if(this!=NULL && punteroAfuncion!=NULL)
    {
        retorno=0;
        for(i=0;i<al_len(this);i++)
        {
